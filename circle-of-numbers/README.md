<div class="markdown -arial"><p>Consider integer numbers from <code>0</code> to <code>n - 1</code> written down along the circle in such a way that the distance between any two neighboring numbers is equal (note that <code>0</code> and <code>n - 1</code> are neighboring, too).</p>
...
<p><img src="https://codesignal.s3.amazonaws.com/uploads/1664318506/example.png?raw=true" alt="" title="example"></p>
